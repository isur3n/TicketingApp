...
import com.walmart.surendra.ticketingApp.ticketingService.domain.*;
...
import com.walmart.surendra.ticketingApp.ticketingService.util.LockUtils;
import com.walmart.surendra.ticketingApp.ticketingService.util.PropUtils;
import com.walmart.surendra.ticketingApp.ticketingService.util.SeatHoldTimer;
 ...
 */
@Service("SimpleGroupService")
public class SimpleGroupService implements TicketService, TicketCanceler {

    private static final Logger logger = Logger.getLogger(SimpleGroupService.class);
    ...
    public SimpleGroupService() {
        ...
        show = new Show(rows, cols);
    }

    public SimpleGroupService(Show show) {
        this.show = show;
    }
