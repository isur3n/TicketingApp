...
public interface TicketService {
     ...
     */
    int numSeatsAvailable() throws TicketingServiceException;
    ...
    information
     */
    SeatHold findAndHoldSeats(int numSeats, String customerEmail) throws TicketingServiceException;
     ...
     */
    String reserveSeats(int seatHoldId, String customerEmail) throws TicketingServiceException;
}